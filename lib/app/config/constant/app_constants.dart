class AppConstant {
  ...
  static const double widthRelatedPostViewVertical = 180;
  static const double heightPostViewHorizontal = 120;
  static const double heightMyPostViewHorizontal = 160;
