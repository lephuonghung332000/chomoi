...
class MyPostTabNavigatorRoutes {
  MyPostTabNavigatorRoutes._();

  static final myPost = AppPages.myPostPage.name;
}

class MyPostTabNavigator extends StatelessWidget {
  const MyPostTabNavigator({this.navigatorKey});
  ...
  Widget build(BuildContext context) {
    return AppGetNavigator(
      key: navigatorKey,
      initialRoute: MyPostTabNavigatorRoutes.myPost,
