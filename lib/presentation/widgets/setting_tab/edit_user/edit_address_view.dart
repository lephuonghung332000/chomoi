...
class _EditAddressViewState extends State<EditAddressView>
  ...
  final editUserController = Get.find<EditUserController>();
  ...
  Future<void> fetchProvince() async {
    await editUserController.getProvinces();
    editUserController.provincesState.maybeWhen(
        orElse: () {},
        success: (value) {
          provinces = value;
          setIdProvince();
  ...
  Future<void> fetchDistrict() async {
    await editUserController.getDistricts(provinceId: provinceId);
    editUserController.districtsState.maybeWhen(
        orElse: () {},
        success: (value) {
          districts = value;
          setIdDistrict();
  ...
  Future<void> fetchWards() async {
    await editUserController.getWards(districtId: districtId);
    editUserController.wardState.maybeWhen(
        orElse: () {},
        success: (value) {
          wards = value;
        });
