...
class CupertinoSliverNavigationBarWithLargeTrailingController {
  _CupertinoSliverNavigationBarWithLargeTrailingState? state;

  void bindState(_CupertinoSliverNavigationBarWithLargeTrailingState state) {
    this.state = state;
  }

  void collapse({Duration duration = const Duration(milliseconds: 250)}) {
    state?._collapseHeader(duration);
  }

  void unCollapse({Duration duration = const Duration(milliseconds: 250)}) {
    state?._unCollapseHeader(duration);
  }
...
class CupertinoSliverNavigationBarWithLargeTrailing extends StatefulWidget {
  /// Creates a navigation bar for scrolling lists.
  ///
  /// The [largeTitle] argument is required and must not be null.
  const CupertinoSliverNavigationBarWithLargeTrailing({
    Key? key,
    this.controller,
    this.largeTitle,
    this.largeTrailing,
    ...
    this.brightness,
    this.padding = const EdgeInsetsDirectional.only(start: 0, end: 8),
  ...
  final CupertinoSliverNavigationBarWithLargeTrailingController? controller;

  final Widget? largeTitle;

  final Widget? largeTrailing;
  ...
  @override
  State<CupertinoSliverNavigationBarWithLargeTrailing> createState() =>
      _CupertinoSliverNavigationBarWithLargeTrailingState();
}

class _CupertinoSliverNavigationBarWithLargeTrailingState
    extends State<CupertinoSliverNavigationBarWithLargeTrailing>
  ...
  void _collapseHeader(Duration duration) {
  ...
  void _unCollapseHeader(Duration duration) {
    _animationController.duration = duration;
  ...
  Widget build(BuildContext context) {
    final _NavigationBarStaticComponents components =
      ...
      userLargeTrailing: widget.largeTrailing,
      ...
      builder: (_, __) => MediaQuery(
        ...
        child: SliverPersistentHeader(
          ...
          delegate: _LargeTitleNavigationBarSliverDelegate(
            ...
            maxHeightFactor: _animation.value,
            userMiddle: widget.middle,
...
class _LargeTitleNavigationBarSliverDelegate
  ...
  @override
  double get minExtent => persistentHeight * maxHeightFactor;

  @override
  double get maxExtent =>
      (persistentHeight + _kNavBarLargeTitleHeightExtension) * maxHeightFactor;
                        ...
                        child: Semantics(
                          ...
                          child: Row(
                            children: [
                              ...
                              const Spacer(),
                              if (components.largeTrailing != null)
                                components.largeTrailing!,
                            ],
                          ),
                        ),
                      ),
...
class _NavigationBarStaticComponentsKeys {
  _NavigationBarStaticComponentsKeys()
      : navBarBoxKey = GlobalKey(debugLabel: 'Navigation bar render box'),
        ...
        largeTrailingKey = GlobalKey(debugLabel: 'Large trailing');
  ...
  final GlobalKey largeTrailingKey;
}
...
class _NavigationBarStaticComponents {
  _NavigationBarStaticComponents({
    ...
    required Widget? userLargeTrailing,
    ...
    required bool large,
        ...
        largeTrailing = createLargeTrailing(
          largeTrailingKey: keys.largeTrailingKey,
          userLargeTrailing: userLargeTrailing,
          large: large,
        );
  ...
  final Widget? largeTrailing;
  static KeyedSubtree? createLargeTrailing({
    required GlobalKey largeTrailingKey,
    required Widget? userLargeTrailing,
    required bool large,
  }) {
    if (!large || userLargeTrailing == null) {
      return null;
    }

    return KeyedSubtree(
      key: largeTrailingKey,
      child: userLargeTrailing,
    );
  }
}
